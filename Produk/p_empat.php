...
<body>
    ...
    <div class="container">
        <div class="left-column">
            <h1>Velocity Black</h1>
            <p>
                RonShoes® Velocity® memadukan estetika vintage dengan teknologi modern, menghadirkan perpaduan masa lalu
                dan masa kini.

                Nama Velocity® menangkap esensi dari kecepatan dan kemajuan yang dinamis, selaras dengan filosofi
                Compass® yang memberdayakan individu untuk terus bergerak maju dan mencapai potensi mereka sepenuhnya.
            </p>
            <p>Spesifikasi :</p>
            <ul>
        ...
        <div class="foto-p">
            <img alt="A pair of black high-top sneakers with white laces and a gum sole." height="400"
                src="../asset/4a.webp" width="600" />
        </div>
        <div class="right-column">
            <p class="price">IDR 798,000</p>
            <p>SIZE:</p>
