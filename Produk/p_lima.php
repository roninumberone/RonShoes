...
<body>
    ...
    <div class="container">
        <h1>Gazele Low Black White</h1>
        <p>
            Siluet asli RonShoes® yang memulai semuanya pada tahun 1998, dirancang ulang untuk memadukan pesona
            vintage dengan detail modern. Gazelle Low adalah alas kaki yang dapat Anda gunakan sehari-hari, dengan
            desain berpotongan rendah yang memancarkan gaya yang mudah dan serbaguna untuk segala acara dan
            penampilan.
        </p>
        <p>Spesifikasi :</p>
        <ul>
